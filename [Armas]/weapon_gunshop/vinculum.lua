...
function getData (...)
return exports['PUNK+Armas']:getData (unpack (arg))
end

_getWeaponProperty = getWeaponProperty
function getWeaponProperty (elem, prop)
return exports['PUNK+Armas']:getWeaponProperty (elem, prop)
end
...
function setElementAlpha (ped, alpha)
return exports['PUNK+Armas']:setElementAlpha (ped, alpha)
end
