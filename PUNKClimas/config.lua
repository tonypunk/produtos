...
climas = {			--tabela de climas modificável, já vem configurado nos climas padrões do GTA, para mais informações: https://wiki.multitheftauto.com/wiki/Weather
	["Los Santos"] = {0,1,2,3,4}, -- Climas de Los Santos
	["San Fierro"] = {5,6,7,8,9}, -- Climas de San Fierro
	["Las Venturas"] = {10,11,12}, -- Climas de Las Venturas
	["Red County"] = {13,14,15,16}, -- Climas de Red County
	["Bone County"] = {17,18,19}, -- Climas de Bone County
}
--------------------------------------------------------
